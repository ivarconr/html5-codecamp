...
images.createCanv = function(node) {
    var slides = node.find("li"),
            current = 0,
...
images.createSlideshow = function(node, images) {
    ...
    $.each(images, function(index, value) {
        liElemHtml += "<li><img src=\"" + value + "\" width=\"620\" height=\"320\"/></li>\n";
    })

    var html = '<div class="slideshow"><ul class="slides">' + liElemHtml + "</ul><span class=\"arrow previous\"></span><span class=\"arrow next\"></span></div>";


    node.html(html);

    this.createCanv(node);
